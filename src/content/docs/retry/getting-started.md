...
description: Install and start using Retry for resilient PHP applications with backoff strategies.
---
...
- [Functional API](/retry/functional-api/) - Using the `retry()` function
- [OOP API](/retry/oop-api/) - Fluent interface with conditional retries
- [Backoff Strategies](/retry/backoff-strategies/) - All 8 backoff algorithms
- [Examples](/retry/examples/) - Real-world usage patterns
