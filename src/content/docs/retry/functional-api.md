...
description: Use the retry() function for composable, functional retry logic in PHP.
---
...
For conditional retries or max delay caps, use the [OOP API](/retry/oop-api/).
