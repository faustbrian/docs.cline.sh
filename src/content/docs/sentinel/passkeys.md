---
title: Passkeys Integration
description: Complete integration guide for implementing passkey authentication with synced credentials.
---
...
- [Security Keys](/sentinel/security-keys) - Device-bound WebAuthn credentials
- [Recovery Codes](/sentinel/recovery-codes) - Backup authentication method
- [Events](/sentinel/events) - Listen to passkey registration/usage
