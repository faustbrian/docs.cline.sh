...
description: Complete guide for implementing comprehensive multi-factor with TOTP, passkeys, security keys, and recovery codes
---
...
- [Passkeys Integration](/sentinel/passkeys) - Synced WebAuthn credentials
- [Security Keys Integration](/sentinel/security-keys) - Device-bound credentials
- [TOTP Setup](/sentinel/totp) - Authenticator app configuration
- [Events](/sentinel/events) - multi-factor event handling
- [Testing](/sentinel/testing) - Comprehensive test examples
