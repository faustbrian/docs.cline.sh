---
title: Security Keys Integration
description: Complete integration guide for device-bound WebAuthn credentials (YubiKey, Titan Key, etc.)
---
...
- [Passkeys Integration](/sentinel/passkeys) - For synced credentials
- [Multi-Factor Authentication](/sentinel/mfa) - Complete multi-factor guide
- [WebAuthn Events](/sentinel/events#webauthn-events) - Event handling
- [Testing Guide](/sentinel/testing#webauthn-tests) - Comprehensive testing
