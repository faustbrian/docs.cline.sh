---
title: Basic Usage
description: The IdempotencyKey class generates consistent cryptographic hashes from any data structure, automatically normalizing inputs so that identical data produces identical keys regardless of key order.
---
...
See [Hash Algorithms](/idempotency/hash-algorithms/) for other options.
