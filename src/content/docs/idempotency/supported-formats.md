...
description: The IdempotencyKey class automatically detects and normalizes various data formats. All formats are converted to a canonical representation before hashing.
---
